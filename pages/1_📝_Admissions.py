...
with st.form("admission_form"):
    ...
    # THE FIX: The button is now OUTSIDE the tabs, but INSIDE the form!
    st.markdown("---")
    ...
    if not child_name or not address:
        ...
        with st.spinner("Encrypting and saving to database..."):
            ...
            try:
                ...
                st.success(f"✅ Successfully registered {child_name} with ID: {form_no}! Total Fees Locked at ₹{total_payable}.")
                st.balloons()
            except Exception as e:
